...
<link rel="resource" type="application/l10n" href="pdf_assets/locale/locale.properties">
<script src="pdf_assets/build/pdf.js"></script>
    ...
    <script type="text/javascript">
      ...
      //let new_file_name="sample_pdf.pdf";
...
<input type="hidden" id="txt_data" name="txt_data">
...
<!--<button type="submit" onclick="downloadfile()" class="btn btn-success" style="margin-top:30px"><i class="bi bi-cloud-upload me-1"></i>Submit</button>-->
