            ...
            <div class="card-body">
              ...
              <!--<form class="row g-3">-->
                ...
                */
                ...
                {
                  echo "<center><div style='margin-top:20px;margin-bottom:20px'><strong style='color:red;'>You have cancelled the signature process. 
                  Admin is notified of your response.</strong></div></center>";
                  ?>
                  <script type="text/javascript">
                    document.getElementById('nextButton').style.display="none";
                    document.getElementById('cancelButton').style.display="none";
