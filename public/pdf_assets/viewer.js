...
const PDFViewerApplication = {
  ...
  //  try {
      ...
      //added by sandip
      //saveAs(blob, 'newandip.pdf');
      //alert(blob);
      //$("#txt_data").val("helo world");
      document.getElementById('txt_data').value=blob;
...
const defaultOptions = {
  ...
  workerSrc: {
    value: "pdf_assets/build/pdf.worker.js",
    kind: OptionKind.WORKER
  }
};

{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "pdf_assets/build/pdf.sandbox.js",
    kind: OptionKind.VIEWER
  };
}
...
class DownloadManager {
  ...
  download(blob, url, filename, _options) {
    ...
    */
    formdata.append('pdfFile', blob, 'compressed.tracemonkey-pldi-09');
    //added by sandip

    var ajax = new XMLHttpRequest();
    var doc_id=document.getElementById('txt_document_id').value;
    var form_id = document.getElementById('txt_form_id').value;
    //alert(doc_id+":"+form_id);
    //ajax.open("POST", app_url+"/save_file?id=compressed.tracemonkey-pldi-09",true);
    //alert("this is first save call");
    ajax.open("POST", app_url+"/save_file?document_id="+doc_id+"&form_id="+form_id,true);
...
setTimeout(function() {flattenForm()}, 5000);
