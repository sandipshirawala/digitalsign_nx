    ...
    */
    ...
    setTimeout(async function() {
        ...
        */
        ...
        {
        var xhr2 = new XMLHttpRequest();
            xhr2.open('POST', app_url+"/merge_flatten_file?filename=output_"+filename, true);
            xhr2.setRequestHeader("X-CSRF-TOKEN",document.getElementById('csrf-token').value);
            //xhr2.responseType = 'blob';
            xhr2.onload = function(e) {
